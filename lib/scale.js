...
var scales = {
  [knowledge.aeolian]: ['P1', 'M2', 'm3', 'P4', 'P5', 'm6', 'm7'],
  blues: ['P1', 'm3', 'P4', 'd5', 'P5', 'm7'],
  chromatic: ['P1', 'm2', 'M2', 'm3', 'M3', 'P4',
    'A4', 'P5', 'm6', 'M6', 'm7', 'M7'],
  [knowledge.dorian]: ['P1', 'M2', 'm3', 'P4', 'P5', 'M6', 'm7'],
  doubleharmonic: ['P1', 'm2', 'M3', 'P4', 'P5', 'm6', 'M7'],
  harmonicminor: ['P1', 'M2', 'm3', 'P4', 'P5', 'm6', 'M7'],
  [knowledge.ionian]: ['P1', 'M2', 'M3', 'P4', 'P5', 'M6', 'M7'],
  [knowledge.locrian]: ['P1', 'm2', 'm3', 'P4', 'd5', 'm6', 'm7'],
  [knowledge.lydian]: ['P1', 'M2', 'M3', 'A4', 'P5', 'M6', 'M7'],
  majorpentatonic: ['P1', 'M2', 'M3', 'P5', 'M6'],
  melodicminor: ['P1', 'M2', 'm3', 'P4', 'P5', 'M6', 'M7'],
  minorpentatonic: ['P1', 'm3', 'P4', 'P5', 'm7'],
  [knowledge.mixolydian]: ['P1', 'M2', 'M3', 'P4', 'P5', 'M6', 'm7'],
  [knowledge.phrygian]: ['P1', 'm2', 'm3', 'P4', 'P5', 'm6', 'm7'],
...
var orderedModes = {
  1: knowledge.ionian,
  2: knowledge.dorian,
  3: knowledge.phrygian,
  4: knowledge.lydian,
  5: knowledge.mixolydian,
  6: knowledge.aeolian,
  7: knowledge.locrian
};
...
Scale.prototype = {
  ...
  // provided a scale degree, returns the scale representing the
  // mode at the degree relative to the current scale
  mode: function(degree) {
    if (this.modeDegree) {
      var newDegree = this.modeDegree + degree > 7 ? (this.modeDegree + degree) - 7 : this.modeDegree + degree;
      return new Note(this.tonic).scale(orderedModes[newDegree])
    }
